           ...
           var screenBottom = $('.screen-bottom');
                   Tl
                       ...
                       function clkAnimComplete() {
                           ...
                           Tl.to('.screen-home__submit-wrap', 0.6, {width: 1100, height: 90, x: -15, y: -409, ease: Expo.easeOut })
                           Tl.to(nextbutton, 0.6, {scale: 1, width: 1100, height: 90, borderRadius: 0, ease: Expo.easeOut, onStart: visibleBox})
